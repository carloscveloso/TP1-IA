...
class BidirectionalAStar:
    ...
    def bidirectional_a_star(self, start, goal):
        ...
        while forward_open and backward_open:
            if forward_open:
                ...
                for neighbor, weight in self.graph[current_forward]:
            ...
            if backward_open:
                ...
                for neighbor, weight in self.graph[current_backward]:
    ...
    def reconstruct_path(self, meeting_point, forward_parents, backward_parents, forward_g, backward_g):
        """Reconstructs the shortest path from forward and backward searches."""
        path = []
